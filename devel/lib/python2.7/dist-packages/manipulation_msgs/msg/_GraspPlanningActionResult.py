...
"""autogenerated by genpy from manipulation_msgs/GraspPlanningActionResult.msg. Do not edit."""
import sys
...
class GraspPlanningActionResult(genpy.Message):
  _md5sum = "3e6fbb82747590d8df5c4c99a3c657e8"
  _type = "manipulation_msgs/GraspPlanningActionResult"
...
int32 value"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','manipulation_msgs/GraspPlanningResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(GraspPlanningActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = manipulation_msgs.msg.GraspPlanningResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = manipulation_msgs.msg.GraspPlanningResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if python3 or type(_x) == unicode:
        ...
        length = len(_x)
      buff.write(struct.pack('<I%ss'%length, length, _x))
      length = len(self.result.grasps)
      buff.write(_struct_I.pack(length))
      for val1 in self.result.grasps:
        _x = val1.id
        length = len(_x)
        if python3 or type(_x) == unicode:
          _x = _x.encode('utf-8')
      ...
      buff.write(_get_struct_i().pack(self.result.error_code.value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        self.result.grasps.append(val1)
      start = end
      end += 4
      (self.result.error_code.value,) = _get_struct_i().unpack(str[start:end])
      return self
