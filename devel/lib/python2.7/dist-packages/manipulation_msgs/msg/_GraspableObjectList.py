    ...
    try:
      ...
      for val1 in self.graspable_objects:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(_v12.is_dense))
        length = len(_v11.mask)
        buff.write(_struct_I.pack(length))
        pattern = '<%si'%length
        buff.write(struct.pack(pattern, *_v11.mask))
        _v15 = _v11.image
        _v16 = _v15.header
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v21.D))
    ...
    try:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v32.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v32.db = str[start:end].decode('utf-8')
          else:
        ...
        _v42.mask = struct.unpack(pattern, str[start:end])
        _v46 = _v42.image
        _v47 = _v46.header
        start = end
        end += 4
        ...
        if python3:
          _v49.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v52.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        _v52.D = struct.unpack(pattern, str[start:end])
        start = end
        end += 72
    ...
    try:
      ...
      for val1 in self.graspable_objects:
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(_v74.is_dense))
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v108.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v111.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v114.distortion_model = str[start:end].decode('utf-8')
        else:
