...
float64 z"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.region.cloud.is_dense))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.reference_frame_id = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v8.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v8.db = str[start:end].decode('utf-8')
        else:
      ...
      if python3:
        self.region.cloud.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.image.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.image.encoding = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.disparity_image.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.disparity_image.encoding = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.cam_info.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.cam_info.distortion_model = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.region.roi_box_pose.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.collision_name = str[start:end].decode('utf-8')
      else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v22.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v22.db = str[start:end].decode('utf-8')
        else:
