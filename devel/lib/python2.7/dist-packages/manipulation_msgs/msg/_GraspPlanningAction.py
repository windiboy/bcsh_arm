  ...
  def serialize(self, buff):
    ...
    try:
      ...
      if type(_x) in [list, tuple]:
        ...
        buff.write(struct.pack('<I%ss'%length, length, _x))
      buff.write(_get_struct_B().pack(self.action_goal.goal.target.region.cloud.is_dense))
      ...
      for val1 in self.action_result.result.grasps:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v61.position))
        length = len(_v61.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v61.velocity))
        length = len(_v61.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v61.effort))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v64.position))
        length = len(_v64.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v64.velocity))
        length = len(_v64.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v64.effort))
      ...
      for val1 in self.action_feedback.feedback.grasps:
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v83.position))
        length = len(_v83.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v83.velocity))
        length = len(_v83.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v83.effort))
        ...
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v86.position))
        length = len(_v86.velocity)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v86.velocity))
        length = len(_v86.effort)
        buff.write(_struct_I.pack(length))
        pattern = '<%sd'%length
        buff.write(struct.pack(pattern, *_v86.effort))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v105.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v105.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        _v112.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v112.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v112.effort = struct.unpack(pattern, str[start:end])
        ...
        _v115.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v115.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v115.effort = struct.unpack(pattern, str[start:end])
      ...
      for i in range(0, length):
        ...
        _v144.mask = struct.unpack(pattern, str[start:end])
        _v148 = _v144.image
        _v149 = _v148.header
        start = end
        end += 4
        ...
        if python3:
          _v148.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v151.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v154.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        _v154.D = struct.unpack(pattern, str[start:end])
        start = end
        end += 72
      ...
      for i in range(0, length):
        ...
        _v165.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v165.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v165.effort = struct.unpack(pattern, str[start:end])
        ...
        _v168.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v168.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v168.effort = struct.unpack(pattern, str[start:end])
      ...
      for i in range(0, length):
        ...
        _v187.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v187.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v187.effort = struct.unpack(pattern, str[start:end])
        ...
        _v190.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v190.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v190.effort = struct.unpack(pattern, str[start:end])
  ...
  def serialize_numpy(self, buff, numpy):
    ...
    try:
      ...
      for val1 in self.action_goal.goal.target.potential_models:
        ...
        _v210 = val1.pose
        _v211 = _v210.header
        buff.write(_get_struct_I().pack(_v211.seq))
        _v212 = _v211.stamp
        _x = _v212
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v211.frame_id
      ...
      for val1 in self.action_goal.goal.grasps_to_evaluate:
        ...
        _v217 = _v216.header
        buff.write(_get_struct_I().pack(_v217.seq))
        _v218 = _v217.stamp
        _x = _v218
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v217.frame_id
        ...
        _v223 = _v222.header
        buff.write(_get_struct_I().pack(_v223.seq))
        _v224 = _v223.stamp
        _x = _v224
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v223.frame_id
        ...
        _v235 = _v234.header
        buff.write(_get_struct_I().pack(_v235.seq))
        _v236 = _v235.stamp
        _x = _v236
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v235.frame_id
      ...
      for val1 in self.action_goal.goal.movable_obstacles:
        ...
        _v245 = val1.cluster
        _v246 = _v245.header
        buff.write(_get_struct_I().pack(_v246.seq))
        _v247 = _v246.stamp
        _x = _v247
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v246.frame_id
        ...
        _v249 = _v248.cloud
        _v250 = _v249.header
        buff.write(_get_struct_I().pack(_v250.seq))
        _v251 = _v250.stamp
        _x = _v251
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v250.frame_id
        ...
        if type(_x) in [list, tuple]:
          ...
          buff.write(struct.pack('<I%ss'%length, length, _x))
        buff.write(_get_struct_B().pack(_v249.is_dense))
      ...
      for val1 in self.action_result.result.grasps:
        ...
        _v270 = _v269.header
        buff.write(_get_struct_I().pack(_v270.seq))
        _v271 = _v270.stamp
        _x = _v271
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v270.frame_id
        ...
        _v273 = _v272.header
        buff.write(_get_struct_I().pack(_v273.seq))
        _v274 = _v273.stamp
        _x = _v274
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v273.frame_id
        ...
        _v288 = _v287.header
        buff.write(_get_struct_I().pack(_v288.seq))
        _v289 = _v288.stamp
        _x = _v289
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v288.frame_id
      ...
      for val1 in self.action_feedback.feedback.grasps:
        ...
        _v298 = _v297.header
        buff.write(_get_struct_I().pack(_v298.seq))
        _v299 = _v298.stamp
        _x = _v299
        buff.write(_get_struct_2I().pack(_x.secs, _x.nsecs))
        _x = _v298.frame_id
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v313.key = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v313.db = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v327.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        for i in range(0, length):
          ...
          if python3:
            _v344.frame_id = str[start:end].decode('utf-8')
          else:
        ...
        if python3:
          _v356.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v359.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v362.distortion_model = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v367.frame_id = str[start:end].decode('utf-8')
        else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v374.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v377.frame_id = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v387.frame_id = str[start:end].decode('utf-8')
        else:
