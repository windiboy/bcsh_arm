...
// (in-package manipulation_msgs.srv)
...
let GraspableObject = require('../msg/GraspableObject.js');
let Grasp = require('../msg/Grasp.js');

//-----------------------------------------------------------

let GraspPlanningErrorCode = require('../msg/GraspPlanningErrorCode.js');
...
class GraspPlanningResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = GraspPlanningErrorCode.serialize(obj.error_code, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    data.error_code = GraspPlanningErrorCode.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.error_code !== undefined) {
      resolved.error_code = GraspPlanningErrorCode.Resolve(msg.error_code)
    }
    else {
      resolved.error_code = new GraspPlanningErrorCode()
    }
...
module.exports = {
  ...
  md5sum() { return '4c2871ee002c11bedb77ea487288e711'; },
  datatype() { return 'manipulation_msgs/GraspPlanning'; }
};
