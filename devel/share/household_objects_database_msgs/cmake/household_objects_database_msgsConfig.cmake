...
if("TRUE" STREQUAL "TRUE")
  set(household_objects_database_msgs_SOURCE_PREFIX /home/yang/my_ws/src/ros_exploring/household_objects_database_msgs)
  set(household_objects_database_msgs_DEVEL_PREFIX /home/yang/my_ws/devel)
  ...
  set(household_objects_database_msgs_INSTALL_PREFIX /home/yang/my_ws/install)
...
if(NOT "/home/yang/my_ws/devel/include " STREQUAL " ")
  ...
  elseif(NOT " " STREQUAL " ")
    ...
    set(_report "Report the problem to the maintainer 'Matei Ciocarlie <matei.ciocarlie@gmail.com>, Isaac I. Y. Saito <130s@2000.jukuin.keio.ac.jp>' and request to fix the problem.")
  endif()
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'household_objects_database_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/my_ws/src/ros_exploring/household_objects_database_msgs/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT household_objects_database_msgs_NUM_DUMMY_TARGETS)
      set(household_objects_database_msgs_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::household_objects_database_msgs::wrapped-linker-option${household_objects_database_msgs_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR household_objects_database_msgs_NUM_DUMMY_TARGETS "${household_objects_database_msgs_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::household_objects_database_msgs::wrapped-linker-option${household_objects_database_msgs_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND household_objects_database_msgs_LIBRARIES "${interface_target_name}")
...
set(household_objects_database_msgs_EXPORTED_TARGETS "household_objects_database_msgs_generate_messages_cpp;household_objects_database_msgs_generate_messages_eus;household_objects_database_msgs_generate_messages_lisp;household_objects_database_msgs_generate_messages_nodejs;household_objects_database_msgs_generate_messages_py")
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${household_objects_database_msgs_dep}_FOUND)
      find_package(${household_objects_database_msgs_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${household_objects_database_msgs_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
