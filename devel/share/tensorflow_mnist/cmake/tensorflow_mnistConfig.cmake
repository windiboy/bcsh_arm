...
if("TRUE" STREQUAL "TRUE")
  set(tensorflow_mnist_SOURCE_PREFIX /home/yang/my_ws/src/ros_exploring/robot_learning/tensorflow_mnist)
  set(tensorflow_mnist_DEVEL_PREFIX /home/yang/my_ws/devel)
  ...
  set(tensorflow_mnist_INSTALL_PREFIX /home/yang/my_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'tensorflow_mnist' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/my_ws/src/ros_exploring/robot_learning/tensorflow_mnist/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT tensorflow_mnist_NUM_DUMMY_TARGETS)
      set(tensorflow_mnist_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::tensorflow_mnist::wrapped-linker-option${tensorflow_mnist_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR tensorflow_mnist_NUM_DUMMY_TARGETS "${tensorflow_mnist_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::tensorflow_mnist::wrapped-linker-option${tensorflow_mnist_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND tensorflow_mnist_LIBRARIES "${interface_target_name}")
