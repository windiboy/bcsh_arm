...
if("TRUE" STREQUAL "TRUE")
  set(marm_planning_SOURCE_PREFIX /home/yang/my_ws/src/ros_exploring/robot_marm/marm_planning)
  set(marm_planning_DEVEL_PREFIX /home/yang/my_ws/devel)
  ...
  set(marm_planning_INSTALL_PREFIX /home/yang/my_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'marm_planning' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/yang/my_ws/src/ros_exploring/robot_marm/marm_planning/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT marm_planning_NUM_DUMMY_TARGETS)
      set(marm_planning_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::marm_planning::wrapped-linker-option${marm_planning_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR marm_planning_NUM_DUMMY_TARGETS "${marm_planning_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::marm_planning::wrapped-linker-option${marm_planning_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND marm_planning_LIBRARIES "${interface_target_name}")
